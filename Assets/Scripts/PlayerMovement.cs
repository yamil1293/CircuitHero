...
public class PlayerMovement : MonoBehaviour {
    ...
    [SerializeField] float minimumJumpHeight = 1;                       // Set the minimum distance of how far the Player can jump.
    [SerializeField] float maximumJumpHeight = 4;                       // Set the maximum distance of how far the Player can jump.
    ...
    [SerializeField] float timeForFullDash = 1.0f;                      // Used as a limiter for the Player's dash.
    [SerializeField] float dashDistance = 15;                           // Multiplies the amount of force used for the dash.
    [SerializeField] float minimumDashForce = 0.5f;                     // Calculates the minimum distance force to dash.
    [SerializeField] float maximumDashForce = 10.0f;                    // Calculates the maximum distance force to dash.
